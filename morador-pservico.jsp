...
<div class="content">
    <header class="header">
        <h2><b>PRESTADORES DE SERVIÇO</b></h2>
    </header>
        ...
        <section>
            ...
            <div class="row">
                <div class="jarviswidget clearfix" data-widget-editbutton="false">
                    <header>
                        <h2>Essa é a tela onde é possível cadastrar todos os prestadores de serviços.</h2>
                    </header>
                    <div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Cadastro de Prestadores de Serviço</h4>
            </div>
                ...
                <div class="row">
                    <section class="col col-6">
                        ...
                        <label class="input">
                            ...
                            <input type="text" name="cpf-pservico" id="cpf-pservico" data-mask="999.999.999-99">
                        </label>
                    </section>
