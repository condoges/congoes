...
<div class="content">
    <header class="header">
        <h2><b>PRESTADOR DE SERVIÇOS</b></h2>
    </header>
        ...
        <section>
            ...
            <div class="row">
                <div class="jarviswidget clearfix" data-widget-editbutton="false">
                    <header>
                        <h2>Essa é a tela onde é possível visualizar todos os prestadores de serviços do condomínio.</h2>
                    </header>
                    <div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="hasinput" style="width:8%">
                                            <input type="text" class="form-control" placeholder="Número da Unidade" />
                                        </th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Cadastro de Prestador de Serviços </h4>
            </div>
                ...
                <div class="row">
                    <section class="col col-6">
                        ...
                        <label class="input">
                            ...
                            <input type="text" name="cpf-pservico" id="cpf-servico" data-mask="999.999.999-99">
                        </label>
                    </section>
                    <section class="col col-md-6">
                        <label class="label">Número da Unidade</label>
                        <label class="input">
                            <i class="icon-prepend fa fa-user"></i>
                            <input type="text" name="n-unidade" id="n-unidade">
                        </label>
                    </section>
                </div>
                <div class="row">   
                   <section class="col col-md-12">
                        ...
                        <label class="input">
                            <i class="icon-prepend fa fa-user"></i>
                            <input type="text" name="nome-pservico" id="nome-pservico">
                        </label>
                    </section>
                </div>   
                <div class="row">
                    <section class="col col-md-6">
                        ...
                        <label class="input">
                            ...
                            <input type="text" name="cargo-pservico" id="cargo-pservico">
                        </label>
                    </section>
                    <section class="col col-6">
                        ...
                        <label class="input"> 
                            ...
                            <input type="tel" name="telefone-pservico" id="telefone-pservico" placeholder="(xx)xxxx-xxxx" data-mask="(99)9999-9999">
                        </label>
                    </section>
                </div>
            </form>
