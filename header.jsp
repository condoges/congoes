                        ...
                        <c:if test="${page != '/condoges2/' && page != '/condoges2/index.jsp' && page != '/condoges2/cadastro.jsp'}">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="sindico-unidades.jsp">UNIDADES</a>
                                        </li>
                                        <li>
                                            <a href="sindico-moradores.jsp">MORADORES</a>
                                        </li>
                                        <li>
                                            <a href="sindico-visitantes.jsp">VISITANTES</a>
                                        </li>
                                        <li>
                                            <a href="sindico-funcionarios.jsp">FUNCIONÁRIOS</a>
                                        </li>
                                        <li>
                                            <a href="sindico-pservico.jsp">PRESTADORES <br>DE SERVIÇOS</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="sindico-financeiro.jsp">FINANCEIRO</a>
                                </li>
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0)">UTILITÁRIOS</a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="sindico-areas.jsp">ÁREAS COMUNS</a>
                                        </li>
                                        <li>
                                            <a href="sindico-enquete.jsp">ENQUETE</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0)">RELATÓRIO</a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="sindico-cpagar.jsp">CONTAS A PAGAR</a>
                                        </li>
                                        <li>
                                            <a href="sindico-creceber.jsp">CONTAS A RECEBER</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li>
                                    <a href="sindico-solicitacao.jsp"><img src="resources/img/solicitacao.png" alt="logo"/></a>
                                </li>
                                <li>
