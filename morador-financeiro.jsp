        ...
        <section>
            <div class="row">
                <div class="jarviswidget clearfix" data-widget-editbutton="false">
                    <header>
                        <h2>Aqui é possível verificar as contas a pagar.</h2>
                    </header>
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                                ...
                                <tbody>
                                    <% for (int i = 0; i < 100; i++) {%>
                                    <tr>
                                        <td><a href="javascript:void(0)" data-toggle="modal" data-target="#nova-unidade-modal" style="text-align: center; width: 100%; display: block;"><i class="fa fa-print"></i></a></td>
                                        <td>Água / Luz</td>
                                        <td>551,99</td>
                                        <td>01/10/2016</td>
                                        <td>Pago</td>
