        ...
        <section>
            ...
            <div class="row">
                <div class="jarviswidget clearfix" data-widget-editbutton="false">
                    <header>
                        <h2>Funcionário é aquele que exerce funções específicas dentro do prédio, por exemplo, o porteiro.</h2>
                    </header>
                    <div>
                ...
                <div class="row">
                    <section class="col col-6">
                        ...
                        <label class="input">
                            ...
                            <input type="text" name="cpf-funcionario" id="cpf-funcionario" data-mask="999.999.999-99">
                        </label>
                    </section>
                ...
                <div class="row">
                    ...
                    <section class="col col-6">
                        ...
                        <label class="input"> 
                            ...
                            <input type="tel" name="telefone-funcionario" id="telefone-funcionario" placeholder="(xx)xxxx-xxxx" data-mask="(99)9999-9999">
                        </label>
                    </section>
                </div>
            </form>
