...
<div class="content">
    <header class="header">
        <h2><b>AGENDAR PRESTADOR DE SERVIÇO</b></h2>
    </header>
        ...
        <section>
            ...
            <div class="row">
                <div class="jarviswidget clearfix" data-widget-editbutton="false">
                    <header>
                        <h2>Essa é a tela onde é possível cadastrar todos os prestadores de serviços do condomínio/prédio.</h2>
                    </header>
                    <div>
                            ...
                            <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="hasinput" style="width:8%">
                                            <input type="text" class="form-control" placeholder="Hora Entrada" />
                                        </th>
                                    </tr>
                                    <tr>
                                        <th></th>                                      
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Agendamento de Visitantes</h4>
            </div>
               ...
               <form class="smart-form">
                ...
                <div class="row">
                    <section class="col col-md-6">
                        ...
                        <label class="input">
                            <i class="icon-prepend fa fa-briefcase" aria-hidden="true"></i>
                    ...
                    <section class="col col-6">
                        ...
                        <label class="input"> 
                            ...
                            <input type="date" name="data-entrada-pservico" class="datepicker" data-dateformat='dd/mm/yy' id="data-entrada-pservico">
                        </label>
                    </section>
                    <section class="col col-6">
                        ...
                        <label class="input"> 
                            ...
                            <input type="time" name="hora-entrada-pservico" id="hora-entrada-pservico">
                        </label>
                    </section>
                </div>
            </form>
