        ...
        <section>
            ...
            <div class="row">
                <div class="jarviswidget clearfix" data-widget-editbutton="false">
                    <header>
                        <h2>Essa é a tela onde é possível deixar agendado para o porteiro o dia e a hora que chegará uma visita do condomínio.</h2>
                    </header>
                    <div>
                ...
                <div class="row">
                    <section class="col col-md-6">
                        ...
                        <label class="input">
                            ...
                            <input type="text" name="carro-visitante" id="carro-visitante">
                        </label>
                    </section>
                    <section class="col col-6">
                        ...
                        <label class="input"> 
                            ...
                            <input type="date" name="data-entrada-visitante" class="datepicker" data-dateformat='dd/mm/yy' id="data-entrada-visitante">
                        </label>
                    </section>
                    <section class="col col-6">
                        ...
                        <label class="input"> 
                            ...
                            <input type="time" name="hora-entrada-visitante" id="hora-entrada-visitante">
                        </label>
                    </section>
                </div>
            </form>
